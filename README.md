...
cp -r mlops/huggingface-hub ~/.hermes/skills/mlops/huggingface-hub/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/huggingface-hub-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/huggingface-hub-skill.git ~/.hermes/skills/mlops/huggingface-hub/
```
...
```text
skill_view(name="mlops/huggingface-hub")
```
...
```text
Use the huggingface hub skill to <describe your specific task here>
```
...
```text
Gunakan skill huggingface hub untuk <deskripsikan tugas spesifik Anda di sini>
```
